...
async function runMigration() {
  ...
  try {
    ...
    const result = await client.query(
      "SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name IN ('stakeholder_types', 'terminology', 'reference_standards', 'reading_guidance')"
    );
